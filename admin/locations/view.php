...
// Get the count of books assigned to this location
$book_count_query = "SELECT COUNT(*) as book_count FROM books WHERE location_id = ?";
...
<head>
    ...
    <title>View Location - Knowledge Haven</title>
            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <h2 class="mb-4"><?php echo htmlspecialchars($location['name']); ?></h2>
                        
                        <div class="row detail-row">
                            <div class="col-4 detail-label">Location ID:</div>
                            <div class="col-8"><?php echo $location['location_id']; ?></div>
                        </div>
                        
                        <div class="row detail-row">
                            <div class="col-4 detail-label">Code:</div>
                            <div class="col-8"><strong><?php echo htmlspecialchars($location['location_code']); ?></strong></div>
                        </div>
                        
                        <div class="row detail-row">
                            <div class="col-4 detail-label">Floor:</div>
                            <div class="col-8"><?php echo $location['floor']; ?></div>
                        </div>
                        
                        <div class="row detail-row">
                            <div class="col-4 detail-label">Shelf:</div>
                            <div class="col-8"><?php echo htmlspecialchars($location['shelf']); ?></div>
                        </div>
                        ...
                        <div class="row detail-row">
                            <div class="col-4 detail-label">Books Assigned:</div>
                            <div class="col-8"><?php echo $book_count; ?></div>
                        </div>
                        
                        <div class="row detail-row">
                            <div class="col-4 detail-label">Created At:</div>
                            <div class="col-8"><?php echo $location['created_at']; ?></div>
                        </div>
                        
                        <div class="row detail-row">
                            <div class="col-4 detail-label">Last Updated:</div>
                            <div class="col-8"><?php echo $location['updated_at']; ?></div>
                        </div>
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <a href="edit.php?id=<?php echo $location['location_id']; ?>" class="btn btn-edit">
