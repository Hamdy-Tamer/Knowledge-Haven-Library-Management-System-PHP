...
// Get employee details for sidebar and navigation
...
// Get all locations
$locations_query = "SELECT * FROM locations ORDER BY name ASC";
...
<head>
    ...
    <title>Knowledge Haven - Manage Locations</title>
        ...
        <div class="row">
            <div class="col-lg-2 col-md-3 sidebar">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="#"><i class="fas fa-map-marker-alt me-2"></i>Locations</a>
                ...
                <div class="card">
                    <div class="card-header card-header-custom">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-0"><i class="fas fa-map-marker-alt me-2"></i>Manage Locations</h4>
                                    ...
                                    <?php if (mysqli_num_rows($locations_result) > 0): ?>
                                        <?php while($location = mysqli_fetch_assoc($locations_result)): ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($location['shelf']); ?></td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="action-buttons">
                                                        ...
                                                        <a href="delete.php?id=<?php echo $location['location_id']; ?>" 
                                                           ...
                                                           title="Delete"
                                                           onclick="return confirm('Are you sure you want to delete this location?\n\nLocation: <?php echo addslashes($location['name']); ?>')">
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="7" class="text-center py-4">
                                                ...
                                                <p class="text-muted">Click "Add New Location" to start organizing your library.</p>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
