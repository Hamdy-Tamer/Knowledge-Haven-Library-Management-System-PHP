...
// Get all authors
$authors_query = "SELECT * FROM authors ORDER BY name ASC";
...
<head>
    ...
    <title>Knowledge Haven - Manage Authors</title>
        ...
        <div class="row">
            <div class="col-lg-2 col-md-3 sidebar">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="#"><i class="fas fa-user-edit me-2"></i>Authors</a>
                    <a class="nav-link" href="../categories/manage.php"><i class="fas fa-tags me-2"></i>Categories</a>
                ...
                <div class="card">
                    <div class="card-header card-header-custom">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-0"><i class="fas fa-user-edit me-2"></i>Manage Authors</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php if (mysqli_num_rows($authors_result) > 0): ?>
                                        <?php while($author = mysqli_fetch_assoc($authors_result)): ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($author['death_year'] ?: 'N/A'); ?></td>
                                                <td><?php echo htmlspecialchars($author['nationality'] ?: 'N/A'); ?></td>
                                                <td>
                                                    <div class="action-buttons">
                                                        <a href="view.php?id=<?php echo $author['author_id']; ?>" 
                                                           class="btn btn-view btn-sm" title="View">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="edit.php?id=<?php echo $author['author_id']; ?>" 
                                                           class="btn btn-edit btn-sm" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="delete.php?id=<?php echo $author['author_id']; ?>" 
                                                           class="btn btn-delete btn-sm" 
                                                           title="Delete"
                                                           onclick="return confirm('Are you sure you want to delete this author?\n\nAuthor: <?php echo addslashes($author['name']); ?>')">
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="6" class="text-center py-4">
                                                ...
                                                <p class="text-muted">Click "Add New Author" to start building your author list.</p>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
