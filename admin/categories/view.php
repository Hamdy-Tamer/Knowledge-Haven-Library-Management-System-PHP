...
// Get the count of books assigned to this category
$book_count_query = "SELECT COUNT(*) as book_count FROM books WHERE category_id = ?";
...
<head>
    ...
    <title>View Category - Knowledge Haven</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row detail-row">
                            <div class="col-5 detail-label">Category ID:</div>
                            <div class="col-7"><?php echo $category['category_id']; ?></div>
                        </div>
                        
                        <div class="row detail-row">
                            <div class="col-5 detail-label">Books Assigned:</div>
                            <div class="col-7"><?php echo $book_count; ?></div>
                        </div>
                        
                        <div class="row detail-row">
                            <div class="col-5 detail-label">Created At:</div>
                            <div class="col-7"><?php echo $category['created_at']; ?></div>
                        </div>
                        
                        <div class="row detail-row">
                            <div class="col-5 detail-label">Last Updated:</div>
                            <div class="col-7"><?php echo $category['updated_at']; ?></div>
                        </div>
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <a href="edit.php?id=<?php echo $category['category_id']; ?>" class="btn btn-edit">
